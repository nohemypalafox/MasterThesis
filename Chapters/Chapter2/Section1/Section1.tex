...
\begin{figure}[htb] 
	\begin{center}
        ...
        {Chapters/Chapter2/Figures/Mold_and_Fungcide/MF_state_control_adjoint}
		\caption{%
...
\begin{figure}[htb] 
	\begin{center}
    	\includegraphics[width=.65\textwidth,keepaspectratio]%
    	{Chapters/Chapter2/Figures/Mold_and_Fungcide/MF_state_control_adjoint_2}
		\caption{%
        	The horizontal axis represents time $t$. The vertical axis
            represents, in each case, the state $x$, the control $u$ and the
            solution of the adjoint equation $\lambda$. The parameters are
...
\begin{figure}[htb] 
	\begin{center}
    	\includegraphics[width=.65\textwidth,keepaspectratio]%
    	{Chapters/Chapter2/Figures/Mold_and_Fungcide/MF_control_uncontrol_1}
		\caption{%
        	The horizontal axis represents time $t$. The vertical axis
...
\begin{figure}[htb] 
	\begin{center}
    	\includegraphics[width=.65\textwidth,keepaspectratio]%
    	{Chapters/Chapter2/Figures/Mold_and_Fungcide/MF_state_control_adjoint_3}
		\caption{%
        	The horizontal axis represents time $t$. The vertical axis
            represents, in each case, the state $x$, the control $u$ and the
            solution of the adjoint equation $\lambda$. The parameters are
