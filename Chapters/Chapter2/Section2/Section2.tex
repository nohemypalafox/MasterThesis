...
\begin{figure}[htb] 
	\begin{center}
        ...
        {Chapters/Chapter2/Figures/Bacteria/BG_control_uncontrol_1}
		\caption{%
...
\begin{figure}[htb] 
	\begin{center}
    	\includegraphics[width=.65\textwidth,keepaspectratio]%
        {Chapters/Chapter2/Figures/Bacteria/BG_state_control_adjoint_1}
		\caption{%
        	The horizontal axis represents time $t$. The vertical axis
...
\begin{figure}[htb] 
	\begin{center}
    	\includegraphics[width=.65\textwidth,keepaspectratio]%
        {Chapters/Chapter2/Figures/Bacteria/BG_state_control_2}
		\caption{%
        	The horizontal axis represents time $t$. The vertical axis
